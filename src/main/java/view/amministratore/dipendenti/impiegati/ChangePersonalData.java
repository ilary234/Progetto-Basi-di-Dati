package view.amministratore.dipendenti.impiegati;
...
public class ChangePersonalData extends JDialog {
    ...
    public ChangePersonalData(ControllerAmm controller, ImpiegatiPanel impiegatiPanel, String pastResidenza, String pastTelefono, 
            String pastPassword) {
        ...
        var passwordText = new JTextField(pastPassword);
        ...
        salva.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!residenza.isBlank() && !telefono.isBlank() && !password.isBlank()) {
                    ...
                    if (!password.equals(pastPassword)) {
                        impiegatiPanel.updatePassword(password);
                    }
                    ChangePersonalData.this.setVisible(false);
                    ChangePersonalData.this.dispose();
                };
            }
